...
confusionMatrix(as.table(tuneRF(y=output,x=features[-657], mtryStart=100, ntreeTry=50, stepFactor=1, improve=0.01, trace=TRUE, plot=TRUE, doBest=TRUE)$confusion[,-3]))$overall[1]
